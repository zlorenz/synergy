...
Marketing website for Synergy Financial
...
.. code-block:: bash
    ...
    heroku run python synergy/manage.py syncdb --noinput --settings=config.settings
    heroku run python synergy/manage.py migrate --settings=config.settings
    heroku run python synergy/manage.py collectstatic --settings=config.settings
